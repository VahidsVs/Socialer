  ...
  <body>
    <header class="header-bar mb-3">
      <div class="container d-flex flex-column flex-md-row align-items-center p-3">
        <h4 class="my-0 mr-md-auto font-weight-normal"><a href="/" class="text-white">Socialer</a></h4>
        @auth
    ...
    {{ $slot  }}
       ...
       <footer class="border-top text-center small text-muted py-3">
        <p class="m-0">Copyright &copy; {{ date("Y") }} {{  date("M")  }} <a href="/" class="text-muted">OurApp</a>. All rights reserved.</p>
      </footer>
      @auth()
